...
def test_data():
    ...
    def programs(data) -> List[testing.ProgramTestData]:
        ...
        yield testing.ProgramTestData(message=patch_message, name='BNK2: 16', number=1)
    ...
    return testing.TestData(program_generator=programs, rename_name="NEW NAME", not_idempotent=True)
