==========================================================================================
Prophet '08 Factory Program Banks ReadMe File                                  Aug-29-2014
==========================================================================================

The accompanying file, Prophet_08_Programs_1.0.syx, contains all of the factory program 
banks for the Prophet '08. The data is in a MIDI System Exclusive (SysEx) file that can be 
loaded into the Prophet '08 via MIDI using a MIDI utility or other application capable of 
...
You will also need a MIDI interface to connect your computer to the Prophet '08.

There is nothing you need to do to prepare the Prophet '08 to receive the programs. Once 
the transfer begins, the programs will automatically be written to the Prophet '08's 
memory.
...
the manual for more information about initiating a SysEx dump from the Prophet '08's front 
panel controls.
...
Connect the MIDI out of your computer's MIDI interface to the Prophet '08's MIDI in. 
Depending on the type of MIDI interface, you may also need a MIDI cable to connect the 
interface to Prophet '08.
...
4. Click Play.
	You'll see the programs changing on the Prophet '08 as the they are being written.
	
When the transmission completes, you're done!

If the load fails to start, make sure the Prophet '08 is actually receiving MIDI data. On 
the MIDI Channel page of the Global menu, a dot blinks between "MIDI" and "Channel" when 
MIDI data is received. Also, make sure that MIDI SysEx in the Global menu is set to "On."
...
5. In the lower left quadrant of the window, select the MIDI port to which the Prophet '08 
   is connected.
