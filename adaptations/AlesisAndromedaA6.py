...
def make_test_data():
    ...
    def programs(data) -> List[testing.ProgramTestData]:
        ...
        # Give the test code a single example message created from the string above
        yield testing.ProgramTestData(message=single_program, name="Brain Activity  ", number=0, friendly_number="User 000")

    return testing.TestData(program_generator=programs, convert_to_edit_buffer_produces_program_dump=True)
