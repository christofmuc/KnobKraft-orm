...
# Real online JD-800 banks from Polynominal store internal patches as three 256-byte
# DT1 blocks per patch in a consecutive address space at 05 00 00.
_jd800_patch_blocks = [
    DataBlock((0x00, 0x00, 0x00), 0x100, "Patch block A"),
    DataBlock((0x00, 0x02, 0x00), 0x100, "Patch block B"),
    DataBlock((0x00, 0x04, 0x00), 0x100, "Patch block C"),
]
...
def setupHelp():
    return (
        ...
        "Real online bank files validated here use three 256-byte DT1 blocks per stored patch. "
        "The public JDBOOK fixture contains 32 stored patches; 64 live slots are still inferred from Roland documentation."
    )
...
def make_test_data():
    ...
    return testing.TestData(
        ...
        program_dump_request=(0, 11, "F0 41 10 3D 11 05 42 00 00 02 00 37 F7"),
