...
std::shared_ptr<Patch> MKS80::patchFromPatchData(const Synth::PatchData &data, std::string const &name, MidiProgramNumber place) const
{
...
void MKS80::startDownload(SafeMidiOutput *output, std::shared_ptr<ProtocolState> saveState)
{
...
void MKS80::changeInputChannel(MidiController *controller, MidiChannel channel)
{
