...
class MKS80_Parameter : public SynthParameterDefinition {
public:
	enum ParameterType {
		TONE, 
		PATCH
	...
	MKS80_Parameter(ParameterType paramType, int paramIndex, std::string const &name, int min, int max, TValueLookup const &valueLookup);
	...
	static std::vector<SynthParameterDefinition *> allParameterDefinitions;
