...
KawaiK3Patch::KawaiK3Patch(MidiProgramNumber programNo, Synth::PatchData const &patchdata) : Patch(patchdata), number_(programNo)
{
...
SynthParameterDefinition const & KawaiK3Patch::paramBySysexIndex(int /* sysexIndex */) const
{
	throw std::logic_error("The method or operation is not implemented.");
}

std::vector<std::string> KawaiK3Patch::warnings()
{
	jassert(false);
	return std::vector<std::string>();
}

std::vector<SynthParameterDefinition *> KawaiK3Patch::allParameterDefinitions()
{
