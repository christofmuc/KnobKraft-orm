...
std::vector<std::string> kWaveFormNames = {
	...
	"trumpet", "sax", "grand piano II", Chirp::kSquare(), Chirp::kSaw(), Chirp::kSine(), "programmable", "white noise"
};
...
bool KawaiK3Parameter::matchesController(int /*controllerNumber*/) const
{
...
bool KawaiK3Parameter::isActive(Patch const * /*patch*/) const
{
	//TODO
	return true;
}
