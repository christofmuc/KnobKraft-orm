...
* **\#515** Added the LegacyLoaderCapability for adaptations that need to load older or non-standard file formats, and documented the new hook in the Adaptation Programming Guide.
* **\#516** Added the CustomProgramChangeCapability Python binding so adaptations can define their own program change behavior.
* **\#527** Added a simulated MIDI wire test layer for adaptation tests, covering bank downloads, edit buffer requests, and send-to-synth code paths.
...
* **\#433** Added the **Kawai K5000** adaptation with bank import support and test data. Heroic effort by @markusschlosser on this what I think is our most complex adpatation yet!
...
* **Korg R3** adaptation added. By now it is possible to get adaptations 100% written by AI by just giving them the manual download. This adds a new GenericKorg python module which can be used for new Korg adaptations to reduce code duplication.
* **Roland JD-Xi** adaptation added, also 100% AI
* **Roland U-20/U-220** adpatation added, also 100% AI.
